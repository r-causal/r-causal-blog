...
[^2]: I call variables like this continuish because the number of years is represented as an integer. In theory, this concept is continuous, but because it is rounded to the year in the data, there are only `r dplyr::n_distinct(nhefs_weights$smokeyrs)` values in the variable.
